module ApplicationHelper
  ...
  def button_to_remove_fields(name, f)
    content_tag :button, name, class: 'remove_fields button tiny round alert'
  end
  ...
  def button_to_add_fields(name, f, type)
    ...
    content_tag :button, name, :class => 'add_fields button tiny round success', 'data-field-type' => type, 'data-content' => "#{fields}"
  end
